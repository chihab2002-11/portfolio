...
export function TechBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-full border-[var(--border-width)] border-[var(--border-color)] bg-[var(--surface)] px-2.5 py-1 text-xs text-[var(--text-secondary)] transition-colors duration-200",
